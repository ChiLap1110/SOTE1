...
/**
 * This class represents a very basic database that just can save and load
 * strings in a file using a key. There are no further database functions like
 * relations, multiple attributes, transactions and so on.
 * 
 * The class just serves as example to practice exception handling since it
 * occasionally/randomly generates errors/ exceptions
 * 
 * @author DrCJ
...
public class PoorMansDatabase {
	 ...
	 * 
	 * @param filename
	 *            sth like c:\\temp\\mydatabase.csv
	 * @throws IOException
	 *             if file cannot be created or found
	 */
